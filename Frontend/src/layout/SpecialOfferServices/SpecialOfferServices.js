...
const SpecialOfferServices = () => {
  ...
  //   {
  //     id: 1,
  //     title: "Autofinder Free Ads Service",
  //     image: inspimage,
  //   }
  // ];
  ...
  const service = {
    id: 1,
    title: "Autofinder Free Ad Service",
    image: inspimage,
  }; // Use id here
  ...
  return (
    <div className="special-offer-services-container">
      ...
      <h2>How AutoFinder Free Ad Service Works?</h2>
      <div className="steps-container">
        <div className="step-item">
          <img src={one} alt="Step 1" />
          <p>Sign Up for free ad service</p>
        </div>
        <div className="step-item">
      ...
      <div className="note-paragraph">
        <h3>Note:</h3>
        <p>
          It is important to note that while the regular ad listing on the
          Autofinder is typically free, we offer additional paid services such
          as "List for you, Premium Ad service, Car inspection, Boost your Ad"
          to enhance the visibility and promotion of your ad.
        </p>
      </div>
