...
const ListItForYou = () => {
  ...
  const service = {
    id: 1,
    title: "Autofinder Car Inspection",
    image: inspimage,
  }; // Use id here
  ...
  return (
    <div className="special-offer-services-container">
      ...
      />
      <h2>{service.title}</h2>
      <button className="button-post-ad">Schedule Inspection</button>
      ...
      <h2>How AutoFinder Car Inspection Works</h2>
      <div className="steps-container">
        <div className="step-item">
          <img src={one} alt="Step 1" />
          <p>Sign Up for car inspection service</p>
        </div>
        <div className="step-item">
          <img src={two} alt="Step 2" />
          <p>Book a time and location for car inspection service</p>
        </div>
        <div className="step-item">
        ...
        <div className="step-item">
          ...
          <p>
            Get your detailed inspection report in an hour via WhatsApp or email
          </p>
        </div>
      </div>
